...
<body>
    ...
    <main class="middle">
        <section class="welcome">
            ...
            <img src="assets/images/petcare.jpg" alt="Happy pets enjoying care">
        </section>
        ...
        <section class="products">
            <div class="product-item">
                ...
                <a href="products/foods.php">
                    <img src="assets/images/petfoods.jpg" alt="Variety of Pet Foods">
                </a>
            </div>
            <div class="product-item">
                <h3>Pet Tools</h3>
                ...
                <a href="products/tools.php">
                    <img src="assets/images/pettools.jpg" alt="Pet Care Tools">
                </a>
            </div>
        </section>
    </main>
